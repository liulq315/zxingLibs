...
import org.loqs.zxing.view.ViewfinderView;
 ...
 * @author Sean Owen
 */
final class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback {
...
//            bundle.putParcelable("bitmap", barcode);
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            if (handler == null) {
                handler = new CaptureActivityHandler(null, decodeFormats, decodeHints,
