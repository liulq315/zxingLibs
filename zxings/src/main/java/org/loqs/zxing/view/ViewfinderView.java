...
import org.loqs.zxing.camera.CameraManager;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        laserColor = context.getResources().getColor(R.color.laser_color);
        cornerColor = context.getResources().getColor(R.color.corner_color);
        frameColor = context.getResources().getColor(R.color.frame_color);
        resultPointColor = context.getResources().getColor(R.color.result_point_color);
        maskColor = context.getResources().getColor(R.color.mask_color);
        resultColor = context.getResources().getColor(R.color.result_color);
