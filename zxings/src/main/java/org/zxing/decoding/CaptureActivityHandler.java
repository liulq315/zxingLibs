...
public final class CaptureActivityHandler extends Handler {
    ...
    public static final int auto_focus = 0x345;
    public static final int restart_preview = 0x346;
    public static final int decode_succeeded = 0x347;
    public static final int decode_failed = 0x348;
    public static final int return_scan_result = 0x349;
    public static final int launch_product_query = 0x34a;
