...
public class QRCodeUtil {
     ...
     *
     * @param content        内容
     * @param widthAndheight 图片宽度高度
     * @param logoBm         二维码中心的Logo图标（可以为null）
     * @return 生成二维码及保存文件是否成功
     */
    public static Bitmap createQRImage(String content, int widthAndheight, Bitmap logoBm) {
        try {
            ...
            // 图像数据转换，使用了矩阵转换
            BitMatrix bitMatrix = new QRCodeWriter().encode(content, BarcodeFormat.QR_CODE, widthAndheight, widthAndheight, hints);
